  ...
  return (
    <>
      <Container className="flex flex-wrap">
        <div className="flex items-between w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            <h1 className="text-4xl font-bold leading-snug tracking-tight text-gray-800 lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight dark:text-white">
              #ElBarrioOnline
              <br />
              Te ayudamos a vender por internet fácil y barato
            </h1>
            <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">
              Dile adiós a comisiones de entre el 25% y el 30% de empresas como
              Uber Eats o Rappi y comienza a generar más ingresos vendiendo por
              internet. Somos un movimiento creado desde el barrio para el
              barrio.
            </p>
            ...
            <div className="flex flex-col items-start space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row">
              ...
              <a
                target="_blank"
                rel="noopener"
                href="https://wa.me/5542660668"
                data-te-ripple-color="light"
                className="rounded px-6 py-3 text-xs font-medium uppercase leading-normal text-white shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg bg-[#25D366] flex justify-between"
              >
                <svg
